    ...
    dubAVideoOrAnAudioFile(request, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (request.dubbing_studio != null) {
                yield _request.append("dubbing_studio", request.dubbing_studio.toString());
            }
            ...
            const _response = yield core.fetcher({
                ...
                headers: Object.assign({ "xi-api-key": (yield core.Supplier.get(this._options.apiKey)) != null
                        ...
                        : undefined, "X-Fern-Language": "JavaScript", "X-Fern-SDK-Name": "elevenlabs", "X-Fern-SDK-Version": "0.10.0", "X-Fern-Runtime": core.RUNTIME.type, "X-Fern-Runtime-Version": core.RUNTIME.version }, _maybeEncodedRequest.headers),
                requestType: "file",
